                        ...
                        <div class=" w-2/3 md:w-1/4 lg:w-1/5 bg-pink-400 border-0 p-4 rounded-md focus:outline-none mb-4">
                          <div class="text-white text-center rounded text-lg mb-4">タグ名:{{$group->name}}</div>
                            <div class="flex flex-col  ">
                              ...
                              {{-- fin 登録曲一覧ボタン --}}
                              {{--  タイトル編集ボタン --}}
                              <a class="text-white bg-white/25 border-2 border-white-400 p-2 focus:outline-none hover:bg-green-400/60 rounded text-lg  " href="{{route('admin.groups.name.edit' , ['name'=>$group->id] )}}">
                                <div class="flex justify-center">
                                  <p class="mr-1">グループ名</p>
                                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
                                  </svg>
                                </div>
